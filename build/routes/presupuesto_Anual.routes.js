...
var presupuesto_Anual_Controler = require('../controllers/presupuesto_Anual.controller'); //Estoy requiriendo el el objeto FuncionarioCtrl-- Asi tengo todas las
...
router.put('/:id', presupuesto_Anual_Controler.editPresupuesto_Anual); //router.put('/:id', partidas2504_controller.createPartidas2504);//Cada vez que se cree una partida tiene que actualizar el presupuesto anual.

...
codigo_Departamento:{type: Number, require: true, unique: true},
nombre_Departamento:{type: String, require: true},
monto_Ejecutado:{ type: Number, require: true}
},{
    timestamps:true,//Cada vez que agrego o actualizo un dato a mi collections puedo ver cuando fue agregado
